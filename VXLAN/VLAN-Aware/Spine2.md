...
mtu 9200
no switchport
ip address 10.10.20.2/31
!
interface Ethernet3
mtu 9200
no switchport
ip address 10.10.20.4/31
!
interface Ethernet4
mtu 9200
no switchport
ip address 10.10.20.6/31
!
interface Ethernet5
!
interface Ethernet6
...
bgp listen range 10.10.20.0/24 peer-group UNDERLAY peer-filter LEAFS
