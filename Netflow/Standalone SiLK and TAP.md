...
Once everything what set, I wanted to analyze network flow data. Below are some of the queries that I ran to get an overview of 

1. This stat shows the percentage of the records generated by source IP:
...
2. This will show 20 records to show the src ip dst ip, port, protocol, bytes, and number of packets
...
Query #3 
This is looking for the top 20 source-destination pairs based on total bytes transferred. This is looking at traffic coming in where we are the destination
...
identifying long connections more than 28 minutes
