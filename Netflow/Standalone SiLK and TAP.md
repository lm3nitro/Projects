...
## Verify the sniffing  interface ens33:
...
# Find Traffic Types and Repos


itory Storage Times:

Specific sensor and what traffic it carries 
...
These stats show the percentage of the records generated by source ip
...
Shows 20 records to show the src ip dst ip, port, protocol, bytes, and number of packets
